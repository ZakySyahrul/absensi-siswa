    ...
    <div class="card-body">
        <div class="d-md-flex justify-content-between align-items-center mb-3">
            ...
            <div class="import-section">
                @can('admin')
                <form action="/siswa/import" method="POST" enctype="multipart/form-data" class="import-form">
                    @csrf
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    {{-- Modal Edit --}}
                    <div class="modal fade" id="edit-{{ $siswa->id }}" data-backdrop="static" data-keyboard="false"
                                    ...
                                    <form action="/siswa/{{ $siswa->id }}" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="kelas_id" name="kelas_id">
                                                ...
                                                <option value="{{ $data->id }}" {{ $siswa->kelas_id == $data->id ?
                                                    'selected' : '' }}>
                                                    {{ $data->nama_kelas }}
                                                </option>
                                                @endforeach
...
<script>
    $(document).ready(function () {
        // Saat file dipilih, ubah teks label "Choose file" menjadi nama file yang dipilih
